...
class Func_Misc extends CI_Model {
	...
	public function autoload_register($class_name) {
	...
	public function currentpage_public(){
	...
	public function currentpage_admin(){
		$this_page =  $_SERVER['REQUEST_URI']; // will return /path/to/file.php
		
		$path = parse_url($this_page, PHP_URL_PATH);
		// echo $path;
	    $bits = explode('/',$path);
