...
<?php echo $response ?>
	...
	<div class="row">
		<div class="col-lg-12">
			<h3 class=" r">List of Schedule
				<small>|
					<label class="label label-sm" style="font-size: 20px">
						<a href="<?php echo base_url("Staff/calendar?view=add") ?>">
			...
			<table id="example" class="table table-striped" style="font-size: 12px" cellspacing="0">
				...
				<tbody>
					...
					?>
						...
						<td><td>
						<td  width="10%" > 	
						<a title="View Inormation" href="'.base_url.'" class="btn btn-default btn-sm "><i class="fa fa-check"></i></a>
						<a title="Edit" href="'.base_url.'" class="btn btn-info btn-sm" ><i class="fa fa-close"></i></a>
						<a title="Delete" href="'.base_url.'" class="btn btn-danger btn-sm" ><i class="fa fa-file"></i></a>
						</td>
