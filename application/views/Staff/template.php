...
<div class="wrapper ">
  ...
  <ul class="nav">
    ...
    <li class="nav-item <?php echo ($this->Func_Misc->currentpage_admin()  == 'announcement') ? 'active' : ''; ?>">
      <a class="nav-link" href="<?php echo base_url("Staff/announcement")?>">
        <p>Announcements</p>
      </a>
    </li>

    <li class="nav-item <?php echo ($this->Func_Misc->currentpage_admin()  == 'modstudent') ? 'active' : ''; ?>">
      <a class="nav-link" href="<?php echo base_url("Staff/Scholar")?>">
        <p>Scholar</p>
      </a>
    </li>
    ...
    <li class="nav-item <?php echo ($this->Func_Misc->currentpage_admin()  == 'notification') ? 'active' : ''; ?>">
      <a class="nav-link" href="<?php echo base_url("Staff/notification")?>">
      <?php
//  print_r($cur->count);
      ?>
    ...
    <div class="dropdown">
      <li class="nav-item  <?php echo ($this->Func_Misc->currentpage_admin() == 'reports') ? 'active' : ''; ?>" >
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
          <li><a class="dropdown-item" href="<?php echo base_url("Staff/Scholar_list") ?>">Scholar List</a></li>
          <li><a class="dropdown-item" href="<?php echo base_url("Staff/Submitted_Documents") ?>">Submitted Documents</a></li>
          <li><a class="dropdown-item" href="<?php echo base_url("Staff/Attended_activities") ?>">Attended Activities</a></li>
        </ul>
      </li>
    </div>
  </ul>
    ...
    <a href="<?php echo base_url("Staff/notification")?>">
